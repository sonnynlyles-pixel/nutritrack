...
export const SEEDS: FoodItem[] = [
  ...
  // Oikos Pro Drink (ready-to-drink protein shake, 1 bottle = 207mL — real lineup per oikos.com, verified via web search; macros identical across flavors per label)
  ...
  rf('seed-oikos-pro-drink-peach',           "Oikos Pro Drink Peach",              "Oikos",          '1 bottle (207mL)', 120, 23, 5, 1.5, 1, 35, 120, 0, 4),
  rf('seed-oikos-pro-drink-mango-pineapple', "Oikos Pro Drink Mango Pineapple",    "Oikos",          '1 bottle (207mL)', 120, 23, 5, 1.5, 1, 35, 120, 0, 4),
  // Oikos Plain (5.3 oz)
  ...
  // ── Counter High Protein Frozen Meals ────────────────────────────
  rf('seed-counter-beefy-queso',      "Beefy Queso Burrito",                 "Counter",        '1 burrito (204g)', 360, 30, 43, 10, 1.5, 10, 1040, 5, 2),
  rf('seed-counter-chicken-mac',      "Queso Chicken Mac and Cheese",        "Counter",        '1 bowl (284g)',    370, 30, 36, 10,   5, 75, 1150, 2, 6),
];
