...
const SEEDED_FOODS: FoodItem[] = [
  ...
  rf('seed-ws-seasoned-fries',        "Seasoned Fries (Regular)",            "Wingstop",      '1 regular',  310,   4, 41, 15,  3,   0,  840, 3,  0),
  rf('seed-ws-cheese-fries',          "Cheese Fries (Regular)",              "Wingstop",      '1 regular',  440,  10, 46, 24,  8,  30, 1160, 3,  1),
