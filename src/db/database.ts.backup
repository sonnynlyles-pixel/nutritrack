...
const SEEDED_FOODS: FoodItem[] = [
  ...
  // Pub Burgers
  rf('seed-culv-colby-jack-single',   "Colby Jack Pub Burger (Single)",      "Culver's",      '1 burger',   700,  28, 56, 40, 16, 100,  880, 1,  8),
  rf('seed-culv-colby-jack-double',   "Colby Jack Pub Burger (Double)",      "Culver's",      '1 burger',   950,  47, 43, 60, 24, 175, 1180, 1, 10),
  rf('seed-culv-colby-jack-triple',   "Colby Jack Pub Burger (Triple)",      "Culver's",      '1 burger',  1200,  66, 56, 80, 32, 265, 1450, 1, 12),
  rf('seed-culv-mushroom-swiss-single',"Mushroom & Swiss Pub Burger (Single)","Culver's",      '1 burger',   520,  26, 48, 36, 14,  95,  720, 2,  6),
  rf('seed-culv-mushroom-swiss-double',"Mushroom & Swiss Pub Burger (Double)","Culver's",      '1 burger',   780,  44, 45, 56, 22, 165, 1050, 2,  8),
  rf('seed-culv-mushroom-swiss-triple',"Mushroom & Swiss Pub Burger (Triple)","Culver's",      '1 burger',  1050,  62, 56, 75, 30, 245, 1320, 2, 10),
  rf('seed-culv-wisconsin-big-cheese-single',"Wisconsin Big Cheese Pub Burger (Single)","Culver's",'1 burger',   580,  30, 50, 42, 16, 110,  780, 1,  7),
  rf('seed-culv-wisconsin-big-cheese-double',"Wisconsin Big Cheese Pub Burger (Double)","Culver's",'1 burger',   860,  48, 48, 62, 24, 180, 1100, 1,  9),
  rf('seed-culv-wisconsin-big-cheese-triple',"Wisconsin Big Cheese Pub Burger (Triple)","Culver's",'1 burger',  1130,  66, 56, 82, 32, 270, 1380, 1, 11),
  // ButterBurgers variations
  rf('seed-culv-butterburger-triple',  "ButterBurger (Triple)",               "Culver's",      '1 burger',   750,  52, 49, 48, 20, 210, 1200, 2, 10),
  rf('seed-culv-butterburger-chz-double',"Double ButterBurger with Cheese",   "Culver's",      '1 burger',   640,  42, 35, 35, 16, 155, 1070, 1,  7),
  rf('seed-culv-mushroom-swiss-butterburger-single',"Mushroom & Swiss ButterBurger (Single)","Culver's",'1 burger',   460,  24, 46, 32, 13,  90,  680, 2,  6),
  rf('seed-culv-mushroom-swiss-butterburger-double',"Mushroom & Swiss ButterBurger (Double)","Culver's",'1 burger',   680,  40, 45, 52, 21, 160,  990, 2,  8),
  rf('seed-culv-mushroom-swiss-butterburger-triple',"Mushroom & Swiss ButterBurger (Triple)","Culver's",'1 burger',   920,  58, 55, 72, 29, 240, 1260, 2, 10),
  rf('seed-culv-bacon-deluxe-double',  "Bacon Deluxe (Double)",               "Culver's",      '1 burger',   760,  44, 40, 48, 18, 130, 1180, 2, 11),
  rf('seed-culv-bacon-deluxe-triple',  "Bacon Deluxe (Triple)",               "Culver's",      '1 burger',  1000,  62, 50, 68, 26, 220, 1450, 2, 13),
  // Chicken
  rf('seed-culv-grilled-chicken',      "Grilled Chicken Sandwich",            "Culver's",      '1 sandwich', 390,  41, 40,  9,  2,  75, 1040, 3,  8),
  rf('seed-culv-spicy-chicken',        "Spicy Chicken Sandwich",              "Culver's",      '1 sandwich', 480,  32, 52, 18,  3,  65, 1420, 2, 10),
  rf('seed-culv-tenders-2pc',          "Chicken Tenders (2 pc)",              "Culver's",      '2 pieces',   270,  18, 18, 14,  3,  45,  700, 1,  0),
  rf('seed-culv-tenders-4pc',          "Chicken Tenders (4 pc)",              "Culver's",      '4 pieces',   540,  36, 36, 28,  6,  90, 1400, 2,  0),
  rf('seed-culv-tenders-5pc',          "Chicken Tenders (5 pc)",              "Culver's",      '5 pieces',   675,  45, 45, 35,  7, 112, 1750, 2,  0),
  // Fish
  rf('seed-culv-cod-fillet-single',    "North Atlantic Cod Fillet (Single)",  "Culver's",      '1 fillet',   420,  28, 32, 20,  4,  70,  980, 1,  2),
  rf('seed-culv-cod-fillet-double',    "North Atlantic Cod Fillet (Double)",  "Culver's",      '1 fillet',   610,  48, 38, 30,  6, 130, 1380, 1,  3),
  rf('seed-culv-fish-fry-dinner',      "Fish Fry Dinner",                     "Culver's",      '1 dinner',   860,  42, 68, 42,  8, 110, 1560, 2,  5),
  // Sides
  rf('seed-culv-cheese-curds-small',   "Cheese Curds (Small)",                "Culver's",      '1 small',    340,  15, 27, 20,  9,  45,  920, 1,  3),
  rf('seed-culv-cheese-curds-large',   "Cheese Curds (Large)",                "Culver's",      '1 large',   1020,  40, 82, 58, 26, 130, 2760, 2,  8),
  rf('seed-culv-fries-small',          "Crinkle Cut Fries (Small)",           "Culver's",      '1 small',    240,   3, 32, 11,  2,   0,  290, 3,  0),
  rf('seed-culv-fries-large',          "Crinkle Cut Fries (Large)",           "Culver's",      '1 large',    460,   7, 66, 22,  3,   0,  530, 6,  0),
  rf('seed-culv-onion-rings-regular',  "Onion Rings (Regular)",               "Culver's",      '1 regular',  400,   4, 48, 20,  3,   0,  680, 3,  4),
  rf('seed-culv-onion-rings-large',    "Onion Rings (Large)",                 "Culver's",      '1 large',    800,   8, 96, 40,  6,   0, 1360, 6,  8),
  rf('seed-culv-mashed-potatoes',      "Mashed Potatoes & Gravy",             "Culver's",      '1 order',    340,   7, 42, 15,  8,  25,  920, 2,  2),
  rf('seed-culv-coleslaw',             "Coleslaw",                            "Culver's",      '1 side',     180,   2, 10, 15,  2,   0,  380, 2,  8),
  rf('seed-culv-steamed-broccoli',     "Steamed Broccoli",                    "Culver's",      '1 side',      50,   5,  8,  1,  0,   0,  120, 2,  1),
  // Salads
  rf('seed-culv-cranberry-bacon-bleu-grilled',"Cranberry Bacon Bleu Salad (Grilled Chicken)","Culver's",'1 salad', 360,  44, 14, 16,  6,  90,  840, 3,  9),
  rf('seed-culv-cranberry-bacon-bleu-crispy',"Cranberry Bacon Bleu Salad (Crispy Chicken)","Culver's",'1 salad', 480,  32, 24, 26,  8,  65, 1120, 2, 11),
  rf('seed-culv-chicken-cashew-salad', "Chicken Cashew Salad (Grilled)",      "Culver's",      '1 salad',    380,  38, 16, 18,  5,  80,  820, 3,  9),
  rf('seed-culv-garden-fresco-salad',  "Garden Fresco Salad (Grilled)",       "Culver's",      '1 salad',    320,  36, 12, 14,  4,  75,  680, 3,  6),
  // Soups
  rf('seed-culv-broccoli-cheese-soup', "Broccoli Cheese Soup",                "Culver's",      '1 cup',      220,   8, 18, 13,  8,  35,  850, 1,  2),
  rf('seed-culv-wisconsin-cheese-soup',"Wisconsin Cheese Soup",               "Culver's",      '1 cup',      290,  10, 16, 20, 12,  45,  980, 1,  1),
  rf('seed-culv-chicken-noodle-soup',  "Chicken Noodle Soup",                 "Culver's",      '1 cup',      100,   6, 12,  3,  1,  20,  780, 1,  2),
  rf('seed-culv-chicken-dumpling-soup',"Chicken & Dumpling Soup",             "Culver's",      '1 cup',      180,  10, 20,  6,  2,  35,  920, 1,  2),
  rf('seed-culv-george-chili',         "George's Chili",                      "Culver's",      '1 cup',      300,  18, 22, 16,  7,  50, 1040, 4,  3),
  // Frozen Custard Dishes
  rf('seed-culv-vanilla-dish-small',   "Vanilla Frozen Custard Dish (Small)", "Culver's",      '1 small',    250,   6, 30, 12,  7,  70,  130, 0, 26),
  rf('seed-culv-vanilla-dish-regular', "Vanilla Frozen Custard Dish (Regular)","Culver's",      '1 regular',  340,   8, 42, 16,  9,  90,  170, 0, 34),
  rf('seed-culv-vanilla-dish-large',   "Vanilla Frozen Custard Dish (Large)", "Culver's",      '1 large',    510,  12, 63, 24, 14, 140,  260, 0, 51),
  rf('seed-culv-chocolate-dish',       "Chocolate Frozen Custard Dish",       "Culver's",      '1 regular',  360,   9, 44, 17, 10,  95,  190, 1, 36),
  rf('seed-culv-strawberry-dish',      "Strawberry Frozen Custard Dish",      "Culver's",      '1 regular',  350,   8, 45, 16,  9,  90,  160, 0, 37),
  // Cones & Waffle Cones
  rf('seed-culv-waffle-cone-single',   "Waffle Cone (Single Scoop)",          "Culver's",      '1 cone',     350,   7, 44, 16,  9,  90,  200, 0, 34),
  rf('seed-culv-waffle-cone-double',   "Waffle Cone (Double Scoop)",          "Culver's",      '1 cone',     530,  11, 67, 24, 14, 140,  310, 0, 51),
  rf('seed-culv-cake-cone-single',     "Cake Cone (Single Scoop)",            "Culver's",      '1 cone',     320,   6, 42, 15,  8,  80,  180, 0, 33),
  rf('seed-culv-cake-cone-double',     "Cake Cone (Double Scoop)",            "Culver's",      '1 cone',     480,  10, 63, 22, 13, 130,  270, 0, 50),
  // Concrete Mixers
  rf('seed-culv-concrete-oreo-small',  "Concrete Mixer with Oreo (Small)",    "Culver's",      '1 small',    530,  12, 68, 23, 13,  75,  380, 1, 53),
  rf('seed-culv-concrete-oreo-large',  "Concrete Mixer with Oreo (Large)",    "Culver's",      '1 large',    990,  22,127, 43, 24, 140,  700, 1, 99),
  rf('seed-culv-concrete-reeses',      "Concrete Mixer with Reese's",         "Culver's",      '1 regular',  840,  18,108, 36, 19, 105,  520, 2, 87),
  rf('seed-culv-concrete-snickers',    "Concrete Mixer with Snickers",        "Culver's",      '1 regular',  820,  16,106, 35, 18, 100,  480, 2, 85),
  rf('seed-culv-concrete-kit-kat',     "Concrete Mixer with Kit Kat",         "Culver's",      '1 regular',  800,  14,104, 34, 18,  95,  520, 1, 81),
  rf('seed-culv-concrete-m-and-ms',    "Concrete Mixer with M&M's",           "Culver's",      '1 regular',  810,  15,105, 35, 19,  85,  440, 1, 84),
  // Shakes & Malts
  rf('seed-culv-vanilla-shake-small',  "Vanilla Shake (Small)",               "Culver's",      '1 small',    440,  10, 60, 18, 11,  65,  270, 0, 52),
  rf('seed-culv-vanilla-shake-regular',"Vanilla Shake (Regular)",             "Culver's",      '1 regular',  680,  16, 93, 27, 17, 100,  420, 0, 80),
  rf('seed-culv-vanilla-shake-large',  "Vanilla Shake (Large)",               "Culver's",      '1 large',    920,  22,126, 37, 23, 135,  570, 0,108),
  rf('seed-culv-vanilla-malt-regular', "Vanilla Malt (Regular)",              "Culver's",      '1 regular',  800,  19,110, 31, 19, 115,  500, 0, 95),
  rf('seed-culv-chocolate-shake-regular',"Chocolate Shake (Regular)",         "Culver's",      '1 regular',  710,  16, 97, 28, 17, 105,  450, 1, 83),
  rf('seed-culv-strawberry-shake-regular',"Strawberry Shake (Regular)",       "Culver's",      '1 regular',  690,  15, 94, 27, 17, 100,  410, 0, 81),
  // Sundaes
  rf('seed-culv-sundae-hot-fudge',     "Hot Fudge Sundae",                    "Culver's",      '1 sundae',   520,  12, 68, 22, 13,  80,  380, 1, 59),
  rf('seed-culv-sundae-caramel',       "Caramel Sundae",                      "Culver's",      '1 sundae',   540,  11, 73, 22, 13,  85,  350, 0, 64),
  rf('seed-culv-sundae-turtle',        "Turtle Sundae",                       "Culver's",      '1 sundae',   650,  14, 78, 30, 17,  95,  420, 2, 68),
  rf('seed-culv-banana-split',         "Banana Split",                        "Culver's",      '1 split',    720,  14, 96, 30, 18, 110,  420, 2, 80),
